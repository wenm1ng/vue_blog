...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
    ...
    j.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            var r = {};
            r[l.pageName] = e, r[l.limitName] = a.limit,r[layui.setter.request['tokenName']] = (layui.data(layui.setter.tableName)[layui.setter.request['tokenName']] || '');
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), t.ajax({
                ...
                headers: a.headers || {},
                success: function(t) {
                	if(t.code == layui.setter.response.statusCode.logout){
						// top.location.href = layui.setter.baseurl + '/user/login.html';
